...
//创建节点
var div1 = dom.create1("div");
var div2 = dom.create2("<span><div>哥哥</div></span>"); //const div2 = dom.create2("<tr><td>hi</td></tr>");//undefined

var div3 = dom.create3("<tr><td>弟弟</td></tr>");
var div4 = dom.create2("<div>儿子</div>");
var div5 = dom.create2("<div>爸爸</div>");
console.log(div1);
console.log(div2);
console.log(div3); //增删改查节点

dom.after(test, div3);
dom.before(test, div2);
dom.append(test, div4);
dom.wrap(test, div5);
var a = dom.empty(empty);
